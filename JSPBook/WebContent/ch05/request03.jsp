							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
								 <ul>
								   <li>
								     클라이언트 IP <br>
								     - 웹브라우저의 IP주소를 가져옵니다.<br>
								     - <%= request.getRemoteAddr() %>
								   </li>
								   
								   <li>
								     요청 정보 길이 <br>
								     - 웹브라우저의 요청 파라미터 길이를 가져옵니다.<br>
								     - <%= request.getContentLength() %>
								   </li>
								   
								   <li>
								     요청 정보 인코딩 <br>
								     - 웹브라우저의 요청 인코딩 정보를 가져옵니다.<br>
								    ...
								    <li>
								     요청 정보 프로토콜 <br>
								     - 웹브라우저의 요청 프로토콜을 가져옵니다.<br>
								     - <%= request.getProtocol()%>
								   </li>
								   
								     <li>
								     요청 정보 전송방식 <br>
								     - 웹브라우저의 요청 전송방식을 가져옵니다.<br>
								     - <%= request.getMethod()%>
								   </li>
								   
								    <li>
								     요청 URI<br>
								     - 웹브라우저의 요청 URI를 가져옵니다.<br>
								     - <%=request.getRequestURI()%>
								   </li>
								   
								   <li>
								     컨텍스트 경로<br>
								     - 웹브라우저의 요청 경로를 가져옵니다.<br>
								     - <%= request.getContextPath()%>
								   </li>
								   
								    <li>
								     서버이름<br>
								     - 웹브라우저의 요청 이름을 가져옵니다.<br>
								     - <%= request.getServerName()%>
								   </li>
								   
								    <li>
								     서버포트<br>
								     - 웹브라우저의 요청 포트를 가져옵니다.<br>
								     - <%= request.getServerPort()%>
								   </li>
								   
								   <li>
								     쿼리문<br>
								     - 웹브라우저의 요청 파라미터 문자열[물음표(?) 다음 URL에 할당도니 문자열]을 가져옵니다.<br>
