						...
						<div class="col-lg-12">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
								  ...
								  //Enumeration 객체 타입의 변수 en의 hasMoerElemenets()메소드를 통해
								  //저장된 헤더 이름이 있을 때까지 반복하도록 while 문을 작성함
								    while(en.hasMoreElements()){
								    	// 현재 헤더이름을 가져오도록 Enumeration 객체 타입의 변수 en의 nextElement()메소드를 작성함
								    	String headerName = (String)en.nextElement();
								    	//설정된 헤더 이름의 값을 가져오도록 request 내장 객체의 getHeader메소드를 작성
