						...
						<div class="col-lg-12">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">회원가입 페이지
										정보가공</h6>
								</div>
								<div class="card-body">
									<!-- 
								...
								%> --%>
									<%
										// 내가 사용중인 프로젝트 contextPath 경로 (JSPBook/resources.images 경로)
									// 이클립스 상에서 폴더 경로가 아닌 이클립스에서 만들어낸 프로젝트가 배포되서 생성되는 배포 경로가 되겠다!
									...
									response.sendRedirect("total_singin.jsp");
