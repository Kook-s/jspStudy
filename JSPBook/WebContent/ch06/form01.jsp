						...
						<div class="col-lg-12">
							...
							<div class="card shadow mb-4">
								...
								<form action="#" name="member" method="post">
								 아이디 :  <input type="text" name="id" ><input type="button" value="중복확인">
								 ...
								 취 미 : <input type="checkbox"name="hobby" checked="checked">독서
										<input type="checkbox"name="hobby" checked="checked">운동
							            <input type="checkbox"name="hobby" checked="checked">영화 <br>
